...
import NaviparkingLogo from "../graphics/naviparking-logo.svg";
    ...
    >
      ...
      <Box
        ...
        sx={{
          ...
          paddingLeft: { xs: "2.75rem", md: "8.4375rem" },
          paddingRight: { xs: "2.75rem", md: "5rem" },
      ...
      >
        <Box display="flex" flexDirection="column" maxWidth="510px">
          ...
          <p>
            ...
            <br />
            <Box component="div" sx={{ width: { xs: "180px", md: "362px" } }}>
              <NaviparkingLogo />
            </Box>
          </p>
        </Box>
